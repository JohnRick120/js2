...
function open_share_tab() {
    ...
    let profile_url = '';
    if (server_status1 === "True") {
        profile_url = `https://www.xodice.com/users/profile/${current_userValue}/`;
    }
    else {
        profile_url = `http://127.0.0.1:8000/users/profile/${current_userValue}/`;
    }
    let popupMessage = `
...
function copy_user_url() {
    ...
    let text = '';
    if (server_status1 === "True") {
        text = 'https://www.xodice.com/users/profile/${current_userValue}/';
    }
    else {
